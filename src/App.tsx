  ...
  return(
    <div className='App'>
      <header className='App-header'>
        <h1>School NCAA College Basketball Info</h1>
      </header>
    </div>
  );
}
  ...
  render() {
    ...
    return (
      <div>
        ...
        <h3>Location: {singleTeam.city} {singleTeam.state}</h3>
      </div>
    );
  }
}
...
function DisplayTeams() {
  return (
    <div>
      {teamsData["teams"].map(singleTeam => <Team {...singleTeam} />)}
    </div>
  );
}
